                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                            ...
                            <div class="row mb-3">
                                <label for="parent_id" class="col-md-4 col-form-label text-md-end">{{ __('Parent Categories') }}</label>
                                ...
                                <div class="col-md-6">
                                    <select name="parent_id" id="parent_id" class="form-control" multiple>
                                        ...
                                        @foreach($categories as $catItem)
                                            <option value="{{$catItem->id}}" @if($catItem->name === $catItem->id) selected @endif>{{$catItem->name}}</option>
                                        @endforeach
                                    </select>
